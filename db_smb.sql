...
-- Dumping data for table db_smb.users: ~2 rows (approximately)
DELETE FROM `users`;
/*!40000 ALTER TABLE `users` DISABLE KEYS */;
INSERT INTO `users` (`id`, `name`, `username`, `level`, `email`, `notelp`, `alamat`, `password`, `remember_token`) VALUES
	(1, 'deva satrio damara', 'devasatrio', 'super admin', 'satriosuklun@gmail.com', NULL, NULL, '$2y$10$PygMeJ9ibV.SW5rxNekxOe0Xtc1OJZO8Y9ZjP.Pj7bBt4hOl59aQm', NULL),
	(6, 'asdf', 'asfjsfk', 'pengguna', NULL, '02934890', 'askldf', '$2y$10$mMZTWBB5WFmgjU/dKLk6/utny7qiFq2H3byAlnGjwoFjg5hPNSPWa', NULL);
