            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="form-element-list">
                    ...
                    <form action="{{url('nota')}}" method="post">
                        @if(session('status'))
                        <div class="alert alert-success alert-dismissible alert-mg-b-0" role="alert"><button
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <label>No. Nota</label>
                                <div class="nk-int-st">
                                    <input type="text" class="form-control" name="nota" value="{{$row->kode}}" readonly
                                        required>
                                    <br>
                                </div>
                            </div>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button class="btn btn-success btn-sm" type="button" data-toggle="modal"
                                            data-target="#myModalone{{$row2->id}}"><i class="fa fa-wrench"></i></button>
                                        <a href="{{url('hapusdetailnota/'.$row2->id.'/'.$row2->kode_nota)}}"
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                ...
                                <div class="nk-int-st">
                                    <input type="text" id="total_harganya" class="form-control" name="total_harga"
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                ...
                                <div class="nk-int-st">
                                    <input type="text" id="total_bayar" class="form-control" name="total_bayar"
                                        value="{{$row->dibayar}}" readonly>
                                    <input type="hidden" value="{{$row->kekurangan}}" name="kembalianya"
                                        id="kembalianya">
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-right">
                                <button type="button" class="btn btn-primary" data-toggle="modal"
                                    data-target="#formtambahbarang">Tambah Barang</button>
                                    ...
                                    <form action="{{url('nota/tambahdetailnya')}}" method="post">
                                        <div class="form-example-int mg-t-15">
                                            <div class="form-group">
                                                <div class="nk-int-st">
                                                    ...
                                                    <input type="text" name="barang" class="form-control input-xs"
                                                        required>

                                                    <input type="hidden" name="kodenota" class="form-control input-xs"
                                        ...
                                        <div class="form-example-int mg-t-15">
                                            <div class="form-group">
                                                <div class="nk-int-st">
                                                    <label>Jumlah</label>
                                                    <input type="number" name="jumlah" class="form-control input-xs"
                                                        required>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-example-int mg-t-15">
                                            <div class="form-group">
                                                <div class="nk-int-st">
                                                    <label>Harga</label>
                                                    <input type="number" name="harga" class="form-control input-xs"
                                                        required>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-example-int mg-t-15">
                                            <button type="submit"
                                                class="btn btn-success notika-btn-success waves-effect">Simpan</button>
                                            <button type="button" class="btn btn-danger notika-btn-danger waves-effect"
                ...
                <form action="{{url('nota/editdata')}}" method="post">
                    <div class="form-example-int mg-t-15">
                        <div class="form-group">
                            <div class="nk-int-st">
                                <label>Nama Barang</label>
                                <input type="text" name="barang" class="form-control input-xs" value="{{$row2->barang}}"
                                    required>
                                <input type="hidden" name="id" class="form-control input-xs" value="{{$row2->id}}"
                                    required>
                                <input type="hidden" name="kodenota" class="form-control input-xs"
                                    value="{{$row2->kode_nota}}" required>
                            </div>
                        </div>
                    </div>
                    <div class="form-example-int mg-t-15">
                    ...
                    <div class="form-example-int mg-t-15">
                        <div class="form-group">
                            <div class="nk-int-st">
                                <label>Jumlah Dibayar</label>
                                <input type="number" name="jumlahbayar" class="form-control input-xs"
                                    value="{{$row2->jumlah_dibayar}}" required>
                            </div>
                        </div>
                    </div>
                    <div class="form-example-int mg-t-15">
                        <div class="form-group">
                            <div class="nk-int-st">
                                <label>Harga</label>
                                <input type="number" name="harga" class="form-control input-xs" value="{{$row2->harga}}"
                                    required>
                            </div>
                        </div>
                    </div>
