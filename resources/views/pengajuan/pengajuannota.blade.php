                                ...
                                <tbody>
                                  ...
                                  <tr>
                                      ...
                                      <td class="text-center">
                                        ...
                                        <button type="button" class="btn btn-xs btn-info" data-toggle="modal" data-target="#pencarian{{$row->id}}">
                                            <i class="fa fa-cog"></i>
                                        </button>
            ...
            <div class="modal-dialog modals-default">
              <div class="modal-content">
                <div class="modal-body">
                  ...
                  <p>Konfirmasi dan terima nota yang diajukan pellanggan ?</p>
                    <div class="form-example-int mg-t-15">
                        <a href="{{url('terimanota/'.$row->kode)}}" class="btn btn-success notika-btn-success waves-effect">
                            Terima
                        </a>
